<?php
      ...
      if(isset($_POST['addReport'])){
        ...
        $time_out = mysqli_real_escape_string($conn, $_POST['time_out']);
            ...
            $insertRecord = mysqli_query($conn, "INSERT INTO reports VALUES(0,'$_SESSION[admin_id]', '$department', '$course_title', '$course_code', '$lecturer_name', '$time_in', '$time_out', 0, '$level', '$lecture_hall',  'Inactive', current_timestamp())") or die(mysqli_error($db));
