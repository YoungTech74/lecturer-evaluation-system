...
// error_reporting(0);
    ...
    $getUserDetails = "SELECT * FROM admins WHERE id = '$userId';" or die(mysqli_error($conn));
...
if (isset($_POST['newPasswordBtn'])) {
    ...
    if ($new_password !== $new_password_confirm) {
        ...
        $updatePassword = "UPDATE admins SET password = '$new_password_hash' WHERE id = '$userId';" or die(mysqli_error($conn));
