<?php
    ...
    $today = date("Y-m-d");
    $count1 = 0;
    $getRecord = mysqli_query($conn, "SELECT * FROM reports WHERE status = 'Inactive' AND date_created = '$today' AND lecturer_name = '$_SESSION[lecturer_user]' ORDER BY id DESC");
...
<div class="col-lg-12">
	<div class="card ps-5">
		...
		<div class="card-body">
            ...
            <h3 class="float-left p-2">Your Today's Lectures</h3>
			...
			<table class="table tabe-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td data-label="Time"><b><?php echo $search['time_in'] ?></b></td>
    ...
    //------------------------------ if the search button is not clicked -------------------------
        ...
        $count2 = 0;
        $sql = mysqli_query($conn, "SELECT * FROM reports WHERE status = 'Active' AND lecturer_name = '$_SESSION[lecturer_user]' ORDER BY id DESC LIMIT 5");
       if($sql){?>
       <head>
        <link rel="stylesheet" href="../style.css">
       </head>
...
<div class="col-lg-12">
	<div class="card card-outline card-success">
        ...
        <h5 class="float-left ml-30 p-5 ">List of Your previous Lectures</h5>
			<div class="card-tools">
			...
			<table class="table tabe-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td data-label="Leave Time"><b><?php echo $row2['leave_time'] ?></b></td>
						<td data-label="Action"><b><?php echo $row2['date_created'] ?></b></td>
					</tr>	
				<?php endwhile; ?>
				</tbody>
			</table>
