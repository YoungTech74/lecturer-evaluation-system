...
// error_reporting(0);
    ...
    $getUserDetails = "SELECT * FROM lecturers WHERE l_id = '$userId';" or die(mysqli_error($conn));
...
if (isset($_POST['newPasswordBtn'])) {
    ...
    if ($new_password !== $new_password_confirm) {
        ...
        $updatePassword = "UPDATE lecturers SET password = '$new_password_hash' WHERE l_id='$userId';" or die(mysqli_error($conn));
