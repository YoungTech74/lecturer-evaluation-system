...
// error_reporting(0);
    ...
    $getUserDetails = "SELECT * FROM hod_list WHERE id = '$userId';" or die(mysqli_error($conn));
...
if (isset($_POST['newPasswordBtn'])) {
    ...
    if ($new_password !== $new_password_confirm) {
        ...
        $updatePassword = "UPDATE hod_list SET password = '$new_password_hash' WHERE id = '$userId';" or die(mysqli_error($conn));
