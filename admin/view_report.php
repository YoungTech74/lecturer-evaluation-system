                ...
                <?php
                  while ($row = mysqli_fetch_assoc($getRecord)) {
                   ...
                   <div class="col-md-5 mb-2 ms-2 border-righ" style="box-shadow: 5px 5px 8px grey, -5px -1px 8px grey; border-radius: 10px;">
                        ...
                        <label for="">Leave Time : </label><input type="text" value="<?php echo $row['leave_time']; ?>" readonly><br><br>
                       
                        <a href="report_list.php" class="btn btn-xs btn btn-dark pl-3 pe-3">Back</a><br><br>
